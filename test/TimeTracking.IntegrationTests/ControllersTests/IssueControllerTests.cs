...
{
    [TestFixture]
    public class IssueControllerTests:Request<Startup>
    {
        [SetUp]
        ...
        public async Task AssignIssueToUser_WhenRequestIsValid_ReturnsSuccessStatus()
        {
            ...
            var httpResponse = await Post(IssueControllerRoutes.AssignToUser, request);
        ...
        public async Task AssignIssueToUser_WhenNotValidModelPassed_ReturnsValidationError()
        {
            ...
            httpResponse = await Post(IssueControllerRoutes.AssignToUser, request);
        ...
        public async Task GetIssueById_WhenFound_ReturnsIssue()
        {
            ...
            var httpResponse = await _client.GetAsync(IssueControllerRoutes.BaseRoute+"/"+issueId);
            httpResponse.EnsureSuccessStatusCode();
        ...
        public async Task ChangeIssueStatus_WhenRequestIsValid_ReturnsSuccessStatus()
        {
            ...
            var httpResponse = await Post(IssueControllerRoutes.ChangeIssueStatus, request);
            httpResponse.EnsureSuccessStatusCode();
            var response = await httpResponse.BodyAs<ApiResponse<IssueDto>>();
        ...
        public async Task ChangeIssueStatus_WhenNotValidModelPassed_ReturnsValidationError()
        {
            ...
            httpResponse = await Post(IssueControllerRoutes.ChangeIssueStatus, request);
            response = await httpResponse.BodyAs<ApiResponse<IssueDto>>();
            response.CheckValidationException(expectedCount:1);
        ...
        public async Task CreateIssue_WhenProjectNotFound_ReturnsProjectFound()
        {
            ...
            var httpResponse = await Post(IssueControllerRoutes.CreateIssue, request);
        ...
        public async Task CreateIssue_WhenNotValidModelPassed_ReturnsValidationError()
        {
            ...
            httpResponse = await Post(IssueControllerRoutes.CreateIssue, request);
            response = await httpResponse.BodyAs<ApiResponse<IssueDto>>();
            response.CheckValidationException(expectedCount:1);
        ...
        [TestCase(1,2,1,2)]
        [TestCase(1,3,1,3)]
        public async Task GetAllIssuesAsync_WhenRequestValid_ReturnsAllIssues(int page,int size,int expectedPage,int expectedSize)
        {
            ...
            var httpResponse = await _client.GetAsync(IssueControllerRoutes.BaseRoute+"?"+pagedRequest.GetQueryString());
            httpResponse.EnsureSuccessStatusCode();
